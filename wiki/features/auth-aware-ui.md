...
5. `/sign-in` and `/sign-up` resolve the same server auth state and redirect authenticated users to the localized `/dashboard`.
...
- Date: 2026-05-18
- Reason: Updated public home header behavior for authenticated users and theme access.
- Change type: Updated
- Affected areas: public home UI, sign-in/sign-up routing, session entity, user menu sign-out, auth-aware tests.
